...
for song in overjoy_data:
    AAA_score = int(overjoy_data[song]['max_score'] * AAA / 100) + 1
    if(round(BPI_calc(AAA_score, overjoy_data[song]['average'], overjoy_data[song]['zenichi'], overjoy_data[song]['max_score'], overjoy_data[song]['p']), 2) >= 100):
        over100.append(round(BPI_calc(AAA_score, overjoy_data[song]['average'], overjoy_data[song]['zenichi'], overjoy_data[song]['max_score'], overjoy_data[song]['p']), 2))
    AAA_BPI.append(round(BPI_calc(AAA_score, overjoy_data[song]['average'], overjoy_data[song]['zenichi'], overjoy_data[song]['max_score'], overjoy_data[song]['p']), 2))
...
for song in overjoy_data:
    title = overjoy_data[song]['title']
    md5 = overjoy_data[song]['md5']
    AAA_score = int(overjoy_data[song]['max_score'] * AAA / 100) + 1
    AAABPI = round(BPI_calc(AAA_score, overjoy_data[song]['average'], overjoy_data[song]['zenichi'], overjoy_data[song]['max_score'], overjoy_data[song]['p']), 2)
    g = 0
    if(AAABPI<100):
        while(AAABPI>=aaa_border[g]):
            g += 1
...
with open("bpitool/static/json/ex_sc.json", "w") as f:
